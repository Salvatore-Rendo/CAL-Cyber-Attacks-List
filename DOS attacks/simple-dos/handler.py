...
def args_handler():
    parser = argparse.ArgumentParser(
        ...
        Usage examples:
        1. To perform DoS Attack on the target IP and with the default port (8080) and number of threads (500):
           Run: python simple-dos.py 192.168.1.100
        
        2. To specify the target IP at specified port (e.g., 4343) and the number of threads (e.g., 200):
           Run: python your_script.py 192.168.1.100 -p 4343 -t 200
        ''')
    )
    ...
    return args.target_ip, args.port, args.threads